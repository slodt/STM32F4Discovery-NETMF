...
namespace Common
{
    public class Stm32F4Discovery
    {
        ...
        {
            // ReSharper disable InconsistentNaming
            public const Cpu.PWMChannel GreenLED  = Cpu.PWMChannel.PWM_0; //60
            public const Cpu.PWMChannel OrangeLED = Cpu.PWMChannel.PWM_1; //61
            public const Cpu.PWMChannel RedLED    = Cpu.PWMChannel.PWM_2; //62
            public const Cpu.PWMChannel BlueLED   = Cpu.PWMChannel.PWM_3; //63

            public const Cpu.PWMChannel PD12      = Cpu.PWMChannel.PWM_0;  // Pin 60
            public const Cpu.PWMChannel PD13      = Cpu.PWMChannel.PWM_1;  // Pin 61
            public const Cpu.PWMChannel PD14      = Cpu.PWMChannel.PWM_2;  // Pin 62
            public const Cpu.PWMChannel PD15      = Cpu.PWMChannel.PWM_3;  // Pin 63
            public const Cpu.PWMChannel PE9       = Cpu.PWMChannel.PWM_4;  // Pin 73
            public const Cpu.PWMChannel PE11      = Cpu.PWMChannel.PWM_5;  // Pin 75
            public const Cpu.PWMChannel PE13      = Cpu.PWMChannel.PWM_6;  // Pin 77
            public const Cpu.PWMChannel PE14      = Cpu.PWMChannel.PWM_7;  // Pin 78
            // ReSharper restore InconsistentNaming
        }

        public static Cpu.PWMChannel GetChannelFromPin(Cpu.Pin pin)
        {
            switch ((uint)pin)
            {
                case 60: return Cpu.PWMChannel.PWM_0;
                case 61: return Cpu.PWMChannel.PWM_1;
                case 62: return Cpu.PWMChannel.PWM_2;
                case 63: return Cpu.PWMChannel.PWM_3;
                case 73: return Cpu.PWMChannel.PWM_4;
                case 75: return Cpu.PWMChannel.PWM_5;
                case 77: return Cpu.PWMChannel.PWM_6;
                case 78: return Cpu.PWMChannel.PWM_7;
        ...
        public static string GetPinName(Cpu.Pin pin)
        {
            ...
            var num = pinNumber - 16*port;
            var result = "P" + (char)('A' + port) + num;
            return result;
        }
    }
}
